...
Currently, it takes input from [nixtract][nixtract-url] and produces JSON and XML output compliant with the [CycloneDX][cyclonedx-url] 1.3, 1.4, and 1.5 specifications.
...
Example:
```fish
curl "http://localhost:8000/api/analyze?installable=nixpkgs%23hello&bom_format=cyclonedx_1.5_json"
```
...
This project was funded through [NGI0 Entrust](https://nlnet.nl/entrust), a
fund established by [NLnet](https://nlnet.nl) with financial support from the
European Commission's [Next Generation Internet](https://ngi.eu) program. Learn
more at the [NLnet project page](https://nlnet.nl/project/Genealogos).
